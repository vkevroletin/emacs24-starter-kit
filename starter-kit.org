...
- Load user configuration
  #+begin_src emacs-lisp
  (starter-kit-load "starter-kit-personalization.org")
  #+end_src
...
An Emacs port of the Atom Dark theme from Atom.io. Currently there is
no automated theme installation in Starter Kit so you need to install
and enable it by hands:
+ M-x package-install atom-dark
