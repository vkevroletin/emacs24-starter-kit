...
** Starter kit parts enabled by user
   :PROPERTIES:
...
See [[#starter-kit-enabled-parts][starter kit parts enabled by user]]

** Appearance

An Emacs port of the Atom Dark theme from Atom.io. Currently you need
to install and enable it by hands:
