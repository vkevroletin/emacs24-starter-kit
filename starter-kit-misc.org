...
** ido mode
ido-mode is interactive file and buffers selection interface with
fuzzy matching. We use more powerful alternative called [[file:starter-kit-helm.org][helm]]. Here
just configure ido for packages which use ido as selection mechanism.
